...
Чтобы сделать это, игроки должны проникнуть на винодельню через тайный туннель, ведущий в подвал, затем вступить в бой с друидами и их искажёнными слугами-заразами. Однако друиды выращивают черенок «дерева Гултиаса» — вампирического дерева, которое растёт на вершине Холма Былого к югу — внутри стен винодельни, что усложняет игрокам попытки добраться до верхних уровней
