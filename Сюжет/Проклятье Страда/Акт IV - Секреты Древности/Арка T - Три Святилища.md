...
> The arc below is fully compatible with existing versions of prior arcs. However, Chapter [[#T4. The Monster Hunter]], as well as associated sections of the guide in [[Arc C - Into the Valley]], [[Arc E - The Missing Vistana]], [[Арка K - Павшее Аббатство]], and [[Арка L - Логово Волков]] are expected to undergo significant revision **after** the core guide is complete, with the following changes:
>
...
> * When the players first return to the Luna River Crossroads after completing [[Арка S - Солнечный Меч]], they are met by Alexei, who pleads with them to accompany him to the Vistani camp. 
...
> This scene has been modified since its original publication. It now occurs only if the players have not yet ignited the *Sunsword* by their first night away from Mt. Ghakis after completing [[Арка S - Солнечный Меч]]. (Strahd won't willingly leave Castle Ravenloft while the players have an ignited *Sunsword*.)

The first night the players spend away from Mt. Ghakis after completing [[Арка S - Солнечный Меч]], Strahd scries or tracks them as described in [[Arc R - Trials of the Mountain#R3b. The Tyrant’s First Trial|Arc R - Trials of the Mountain]]. 
...
Forty-eight hours after the players leave the *Tome of Strahd* with Exethanter’s spirit in [[Арка S - Солнечный Меч]], he contacts them simultaneously using a continuous, multi-target _sending_ spell to convey the following information:
...
* If the players solved Meda’s riddle in [[Арка S - Солнечный Меч]] and tell Lazlo that the Dark Powers created the apparition Lazlo saw in the Mists, reduce the DC by 5.
...
When the players first return to <span class="citation">P. Luna River Crossroads (p. 40)</span> after completing [[Арка S - Солнечный Меч]], read:
...
When the players first enter Wachterhaus after completing [[Арка S - Солнечный Меч]], Lady Wachter is in <span class="citation">N4k. Den (p. 112)</span> communing with the goddess Ezra. If the players enter this area while Lady Wachter is communing, revise the final sentence of this area’s description to read as follows:
